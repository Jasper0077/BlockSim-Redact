...
class LightTransaction():
    ...
    def create_transactions():
        ...
        gasLimit, usedGas, gasPrice, _ = DistFit.sample_transactions(
            Psize)  # sampling gas based attributes for transactions from specific distribution
    ...
    def execute_transactions():
        ...
        pool = sorted(LightTransaction.pool, key=lambda x: x.gasPrice,
